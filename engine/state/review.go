...
func ReviewRules() []Rule {
	return []Rule{
		...
		{OpType: "approval", OpVersion: 1, Field: "revision", Strategy: "keyed-lww", Key: []string{"subject", "revision"}, Normalize: &NormalizeRule{Key: []string{"subject"}}},
		{OpType: "approval", OpVersion: 1, Field: "verdict", Strategy: "keyed-lww", Key: []string{"subject", "revision"}, Normalize: &NormalizeRule{Key: []string{"subject"}}},
		{OpType: "approval", OpVersion: 1, Field: "subject", Strategy: "keyed-lww", Key: []string{"subject", "revision"}, Normalize: &NormalizeRule{Value: "person", Key: []string{"subject"}}},
		{OpType: "approval", OpVersion: 1, Field: "message", Strategy: "keyed-lww", Key: []string{"subject", "revision"}, Normalize: &NormalizeRule{Key: []string{"subject"}}},
