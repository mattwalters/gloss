...
- `writ.Projects` engine service, `Query.Projects`/`Query.Project` projection queries, and CLI porcelain (`writ project`) for the `project` collaborative object: creation, metadata updates, status transitions, and issue membership.
