...
[DCO](https://developercertificate.org/)). Sign off with `git commit -s`, or
add the trailer by hand:

```
Signed-off-by: Your Name <you@example.com>
```

The DCO check on pull requests enforces this from the first external PR.
